...
- (id)initWithDeviceType: (ICEInt)type {
    ...
    if (self) {
        ...
        @try {
            devicelist = [devices getDevicelist: type];
...
- (NSString *)nameAtIndex: (int)index {
    if (devicelist) {
        return [devicelist objectAtIndex: index];
    }
    return @"none";
}
...
- (void)viewDidLoad
{
    ...
    [self.tableView registerClass: [UITableViewCell class] forCellReuseIdentifier: @"DeviceListCell"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [[devicelist objectAtIndex: indexPath.row] stringByRemovingPercentEncoding];
