...
template<>
const Color<unsigned short>::value_type Color<unsigned short>::limit;
template<>
const Color<unsigned int>::value_type Color<unsigned int>::limit;
template<>
const Color<unsigned long>::value_type Color<unsigned long>::limit;
template<>
const Color<float>::value_type Color<float>::limit;
template<>
const Color<double>::value_type Color<double>::limit;
