...
std::set<long>	RepoReplicator::uuid2ids(ImageRepo& repo,
 ...
 */
int	RepoReplicator::replicate(ImageRepo& src, ImageRepo& dst, bool remove) {
 ...
 */
int	RepoReplicator::synchronize(ImageRepo& repo1, ImageRepo& repo2) {
