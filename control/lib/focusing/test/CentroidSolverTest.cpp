/*
 * CentroidSolverTest.cpp -- test the parabolic solver
 *
...
class CentroidSolverTest : public CppUnit::TestFixture {
private:
...
public:
	...
	CPPUNIT_TEST_SUITE(CentroidSolverTest);
	CPPUNIT_TEST(testBasic);
	CPPUNIT_TEST_SUITE_END();
};

CPPUNIT_TEST_SUITE_REGISTRATION(CentroidSolverTest);

void	CentroidSolverTest::setUp() {
...
void	CentroidSolverTest::tearDown() {
}

void	CentroidSolverTest::testBasic() {
	debug(LOG_DEBUG, DEBUG_LOG, 0, "testBasic() begin");
	CentroidSolver	cs;
	int	position = cs.position(focusitems);
