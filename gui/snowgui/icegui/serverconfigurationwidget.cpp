...
#include "ui_serverconfigurationwidget.h"
 ...
 */
serverconfigurationwidget::serverconfigurationwidget(QWidget *parent)
	: QWidget(parent), ui(new Ui::serverconfigurationwidget) {
	ui->setupUi(this);
...
void	serverconfigurationwidget::setServiceObject(
	...
	setWindowTitle(QString("Configuration"));
	std::string	title
			= astro::stringprintf("Remote configuration on %s",
 ...
 * \brief 
 */
bool	serverconfigurationwidget::getService(const std::string& name) {
	std::string	value("no");
 ...
 */
void	serverconfigurationwidget::setConfiguration(snowstar::ConfigurationPrx configuration) {
	if (!configuration) {
		return;
	}
 ...
 */
void	serverconfigurationwidget::setDaemon(snowstar::DaemonPrx daemon) {
	if (!daemon) {
		return;
	}
	_daemon = daemon;
 ...
 */
void	serverconfigurationwidget::setModules(snowstar::ModulesPrx modules) {
	if (!modules) {
		return;
	}
	_modules = modules;
 ...
 */
void	serverconfigurationwidget::changevalue(const std::string& name,
...
void	serverconfigurationwidget::devicesToggled(bool newvalue) {
	changevalue("devices", true, newvalue);
}

void	serverconfigurationwidget::instrumentsToggled(bool newvalue) {
	changevalue("instruments", false, newvalue);
}

void	serverconfigurationwidget::imagesToggled(bool newvalue) {
	changevalue("images", true, newvalue);
}

void	serverconfigurationwidget::guidingToggled(bool newvalue) {
	changevalue("guiding", false, newvalue);
}

void	serverconfigurationwidget::focusingToggled(bool newvalue) {
	changevalue("focusing", false, newvalue);
}

void	serverconfigurationwidget::repositoriesToggled(bool newvalue) {
	changevalue("repository", false, newvalue);
}

void	serverconfigurationwidget::tasksToggled(bool newvalue) {
	changevalue("tasks", false, newvalue);
}

void	serverconfigurationwidget::gatewayToggled(bool newvalue) {
	changevalue("gateway", false, newvalue);
}

void	serverconfigurationwidget::restartClicked() {
	debug(LOG_DEBUG, DEBUG_LOG, 0, "restart initiated");
	_daemon->restartServer(1.0f);
}

void	serverconfigurationwidget::repodbChanged(QString s) {

	if (!_daemon) {
		debug(LOG_DEBUG, DEBUG_LOG, 0, "no daemon proxy");
		return;
	}
...
void	serverconfigurationwidget::repodbClicked() {
...
void	serverconfigurationwidget::deviceChanged(QString device) {
...
void	serverconfigurationwidget::mountpointChanged(QString m) {
...
void	serverconfigurationwidget::operationFailed(const std::string& s) {
        QMessageBox     message;
 ...
 */
void	serverconfigurationwidget::mountClicked() {
 ...
 * selected mount time
 */
void	serverconfigurationwidget::setfromsourceClicked() {
 ...
 */
void	serverconfigurationwidget::syncClicked() {
 ...
 */
void	serverconfigurationwidget::timeUpdate() {
 ...
 */
void	serverconfigurationwidget::timesourceSelected(int index) {
...
void	serverconfigurationwidget::shutdownClicked() {
	if (!_daemon) { return; }
	QMessageBox	message;
...
void	serverconfigurationwidget::systemClicked() {
	if (!_daemon) { return; }
	QMessageBox	message;
 ...
 */
void    serverconfigurationwidget::closeEvent(QCloseEvent * /* event */) {
        deleteLater();
}
